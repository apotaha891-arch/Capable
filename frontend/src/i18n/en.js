...
const en = {
  ...
  planProPrice: '$49',
  planProTitle: 'Pro',
  planInfluenceTitle: 'Influence',
  planInfluencePrice: '$19',
  planInfluencePer: '/month',
  planInfluenceDesc: 'For validators ready to launch and shape the platform.',
  planInfluenceBadge: 'Get Influence',
  ...
  instantExamplesBack: 'Back to project type',
  instantExamplesTitle: 'Site type examples',
  instantExamplesSubtitle: "A live preview of each type — without leaving your order.",
