...
const ar = {
  ...
  planProPrice: '$49',
  planProTitle: 'برو',
  planInfluenceTitle: 'التأثير',
  planInfluencePrice: '$19',
  planInfluencePer: '/شهرياً',
  planInfluenceDesc: 'لمن يريد الإطلاق والتأثير في مسار المنصة.',
  planInfluenceBadge: 'فعّل التأثير',
  ...
  instantExamplesBack: 'رجوع لاختيار نوع المشروع',
  instantExamplesTitle: 'أمثلة على أنواع المواقع',
  instantExamplesSubtitle: 'معاينة مباشرة لكل نوع — بدون ما تطلع من صفحة الطلب.',
