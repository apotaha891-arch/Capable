...
import {
  ...
  HelpCircle, Upload, X as XIcon, Lock, Tag, EyeOff, ShieldCheck, Loader, CheckCircle, AlertCircle, Search, ShoppingCart,
} from 'lucide-react';
...
// Search, buy, and auto-connect a new domain without leaving Capable — the
// alternative to the "buy externally via Namecheap" link below it. Renders
// nothing until a mount probe confirms the backend has ResellerClub
// credentials configured, so it's invisible (not half-broken) while that
// integration isn't set up yet.
function DomainSearchBuy({ projectId, authFetch, lang, canPremium }) {
